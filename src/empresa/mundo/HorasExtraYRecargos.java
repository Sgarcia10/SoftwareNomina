 ...
 * @author Santiago
 */
public class HorasExtraYRecargos 
{    
    ...
    public final static double HoraExtraNocturnaOrdinaria = 1.75;
    
    public final static double HoraExtraDiurnaFestivo = 2;
    
    public final static double HoraExtraNocturnaFestivo = 2.5;
